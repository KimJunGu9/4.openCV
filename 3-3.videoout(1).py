...
frame_cnt1 = round(cap1.get(cv2.CAP_PROP_FRAME_COUNT))  # 237개의 프레임
frame_cnt2 = round(cap2.get(cv2.CAP_PROP_FRAME_COUNT))  # 324개의 프레임
fps = cap1.get(cv2.CAP_PROP_FPS) # 30의 프레임
...
for i in range(effect_frames):
    ...
    dx = int(w / effect_frames) * i  # (1280 / 60) * i  # 2번영상이 조금씩 조금씩 보여짐
